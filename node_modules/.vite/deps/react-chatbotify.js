...
function _u() {
  return Eu || (Eu = 1, function() {
    ...
    var ye = false, oe = false, pe = false, le = false, Ge = false, De;
...
` + Ie[Re].replace(" at new ", " at ");
        ...
        ht = false, xe.current = ke, Pe(), Error.prepareStackTrace = Te;
      }
    ...
    function Tr(N, Z) {
      if (typeof N.ref == "string" && Yt.current && Z && Yt.current.stateNode !== Z) {
        ...
        qt[K] || ($('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Ke(Yt.current.type), N.ref), qt[K] = true);
      }
    }
    function lr(N, Z) {
      {
        var K = function() {
          Kt || (Kt = true, $("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", Z));
        };
        K.isReactWarning = true, Object.defineProperty(N, "key", {
          get: K,
          configurable: true
        });
      }
    ...
    function Ht(N, Z) {
      {
        var K = function() {
          ur || (ur = true, $("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", Z));
        };
        K.isReactWarning = true, Object.defineProperty(N, "ref", {
          get: K,
          configurable: true
        });
      }
...
Check the top-level render call using <` + K + ">.");
    ...
    function ut(N, Z, K) {
      return Ur(N, Z, K, true);
    }
    function Rr(N, Z, K) {
      return Ur(N, Z, K, false);
    }
    var an = Rr, un = ut;
    Ci.Fragment = b, Ci.jsx = an, Ci.jsxs = un;
  }()), Ci;
}
false ? Du.exports = qu() : Du.exports = _u();
var W = Du.exports;
var Uu = (0, import_react.createContext)({ botOptions: {}, setBotOptions: () => null });
var Zt = () => (0, import_react.useContext)(Uu);
var $u = ({
  ...
  return W.jsxs("div", { style: F, className: "rcb-chat-header-container", children: [
    W.jsxs("div", { className: "rcb-chat-header", children: [
      ((re = f.header) == null ? void 0 : re.showAvatar) && W.jsx("div", { style: Y.headerAvatar, className: "rcb-bot-avatar" }),
      (H = f.header) == null ? void 0 : H.title
    ] }),
    W.jsxs("div", { className: "rcb-chat-header", children: [
      !((x = f.notification) != null && x.disabled) && !(($ = f.theme) != null && $.embedded) && W.jsx(
        "div",
        {
      ...
      !((de = f.audio) != null && de.disabled) && W.jsx(
        "div",
        {
          style: Y.audioIcon,
          onMouseDown: (oe) => {
      ...
      !((ye = f.theme) != null && ye.embedded) && W.jsx(
        "div",
        {
...
var es = ({
  ...
  var Me, ee, re;
  const { botOptions: f } = Zt(), [U, F] = (0, import_react.useState)(false), Y = {
  ...
  function V(H) {
    ...
    function pe() {
      ...
      I.current.scrollTop = le, oe < H ? requestAnimationFrame(pe) : m(false);
    }
    pe();
  }
  ...
  return W.jsx("div", { className: `rcb-message-prompt-container ${_()}`, children: W.jsx(
    "div",
    {
      onMouseEnter: j,
      onMouseLeave: S,
...
var Ru = (0, import_react.createContext)({ messages: [], setMessages: () => null });
var Yu = () => (0, import_react.useContext)(Ru);
var ts = ({
  chatBodyRef: I,
  isBotTyping: h,
  ...
  const x = () => {
    ...
    return W.jsxs(W.Fragment, { children: [
      (be = V == null ? void 0 : V.userBubble) != null && be.dangerouslySetInnerHtml ? W.jsx(
        "div",
        {
      ...
      ((_e = V.userBubble) == null ? void 0 : _e.showAvatar) && W.jsx(
        "div",
        {
    ...
    var be, _e, it;
    return W.jsxs(W.Fragment, { children: [
      ((be = V.botBubble) == null ? void 0 : be.showAvatar) && W.jsx(
        "div",
        {
      ...
      (it = V == null ? void 0 : V.botBubble) != null && it.dangerouslySetInnerHtml ? W.jsx(
        "div",
        {
  ...
  return W.jsxs(
    "div",
    {
      ...
      onScroll: x,
      children: [
        P.map((ve, be) => typeof ve.content != "string" ? W.jsx("div", { children: ve.content }, be) : W.jsx(
          "div",
          {
        ...
        h && W.jsxs("div", { className: "rcb-bot-message-container", children: [
          ((Ce = V.botBubble) == null ? void 0 : Ce.showAvatar) && W.jsx(
            "div",
            {
          ...
          W.jsx(
            "div",
            {
              ...
              className: `rcb-bot-message ${H}`,
              children: W.jsxs("div", { className: "rcb-typing-indicator", children: [
                W.jsx("span", { className: "rcb-dot" }),
                W.jsx("span", { className: "rcb-dot" }),
                W.jsx("span", { className: "rcb-dot" })
              ] })
            }
...
var rs = ({
  ...
  var S, V, P;
  const { botOptions: h } = Zt(), [m, b] = (0, import_react.useState)(false), f = {
  ...
  return W.jsx(
    "div",
    {
      ...
      children: W.jsx("span", { className: "rcb-send-icon", style: F })
    }
  );
};
var Cu = window.SpeechRecognition || window.webkitSpeechRecognition;
var Xr = Cu != null ? new Cu() : null;
var Zn;
var hu;
var Co = false;
var ns = (I, h, m, b, f) => {
  ...
  if (!Co)
    try {
      Co = true, Xr.lang = (Y = I.voice) == null ? void 0 : Y.language, Xr.start();
    } catch {
    }
...
var Tu = () => {
  Xr && (Co = false, Xr && Xr.stop());
};
var yu = (I, h) => {
  var m, b;
  (m = h.voice) != null && m.disabled || !((b = h.chatInput) != null && b.blockSpam) || !Xr || (I && !Co ? (Co = true, Xr.start()) : I || Tu());
};
var pu = (I) => {
  I(), Tu();
};
...
var vu = ["Quickstart", "API Docs", "Examples", "Github", "Discord"];
var os = {
  start: {
...
var Pr = !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
var is = (I) => {
  const h = [];
  let m = "", b = false;
  for (let f = 0; f < I.length; f++) {
    const U = I[f];
    U === "<" ? b ? (h.push(m), m = U) : (b = true, m = U) : U === ">" ? (m += U, h.push(m), m = "", b = false) : b ? m += U : h.push(U);
  }
  return m !== "" && h.push(m), h;
};
var xu = (I) => {
...
var as = ({
  ...
  const { botOptions: S } = Zt(), [V, P] = (0, import_react.useState)(false), [_, Me] = (0, import_react.useState)(0), [ee, re] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
    var Fe;
    const He = f();
  ...
  return W.jsxs(
    "div",
    {
      onMouseDown: (He) => {
        var Fe;
        He.stopPropagation(), !Y && ((Fe = S.theme) == null ? void 0 : Fe.flowStartTrigger) === "ON_CHATBOT_INTERACT" && j(true);
      },
      style: S.chatInputContainerStyle,
      className: "rcb-chat-input",
      children: [
        m && ((_e = S.sensitiveInput) != null && _e.maskInTextArea) ? W.jsx(
          "input",
          {
            ref: I,
            type: "password",
        ...
        W.jsxs("div", { className: "rcb-chat-input-button-container", children: [
          !((it = S.voice) != null && it.disabled) && Pr && W.jsx(
            As,
            {
              inputRef: I,
              textAreaDisabled: h,
          ...
          W.jsx(rs, { handleSubmit: Ne }),
          ((jt = S.chatInput) == null ? void 0 : jt.showCharacterCount) && ((at = S.chatInput) == null ? void 0 : at.characterLimit) != null && ((pt = S.chatInput) == null ? void 0 : pt.characterLimit) > 0 && W.jsxs(
            "div",
            {
...
var us = ({
  ...
  var V, P, _, Me;
  const { botOptions: m } = Zt(), b = (0, import_react.useRef)(null), f = (0, import_react.useRef)(null), [U, F] = (0, import_react.useState)(false), Y = {
    cursor: `url(${(V = m.theme) == null ? void 0 : V.actionDisabledIcon}), auto`
  };
  (0, import_react.useEffect)(() => {
    const ee = (x) => {
      b.current && !b.current.contains(x.target) && f.current && !f.current.contains(x.target) && F(false);
    }, re = () => {
  ...
  return W.jsxs(W.Fragment, { children: [
    ...
    U && W.jsx("div", { className: "rcb-emoji-picker-popup", ref: b, children: (Me = (_ = m.emoji) == null ? void 0 : _.list) == null ? void 0 : Me.map((ee, re) => W.jsx(
      "span",
      {
        className: "rcb-emoji",
...
var Hu = (0, import_react.createContext)({ paths: [], setPaths: () => null });
var Na = () => (0, import_react.useContext)(Hu);
var ss = ({
  inputRef: I,
  flow: h,
  injectMessage: m,
  ...
  var Me, ee, re, H, x;
  const { botOptions: j } = Zt(), { paths: S } = Na(), [V, P] = (0, import_react.useState)(false);
  (0, import_react.useEffect)(() => {
    const $ = U();
    if (!$)
      return;
  ...
  return W.jsx(W.Fragment, { children: V ? W.jsxs("label", { className: "rcb-attach-button-enabled", children: [
    W.jsx(
      "input",
      {
    ...
    "label",
    {
      ...
      children: [
        W.jsx("input", { disabled: true, type: "file" }),
        W.jsx(
          "span",
          {
            style: {
...
var ls = ({
  ...
  return W.jsxs("div", { style: S.footerStyle, className: "rcb-chat-footer-container", children: [
    W.jsxs("div", { className: "rcb-chat-footer", children: [
      !((V = S.fileAttachment) != null && V.disabled) && W.jsx(
        ss,
        {
          inputRef: I,
          flow: h,
      ...
      !((P = S.emoji) != null && P.disabled) && W.jsx(us, { inputRef: I, textAreaDisabled: m })
    ] }),
    W.jsx("span", { children: (_ = S.footer) == null ? void 0 : _.text })
  ] });
};
var cs = ({
  unreadCount: I
  ...
  return W.jsx(W.Fragment, { children: !((j = h.theme) != null && j.embedded) && W.jsx(
    "button",
    {
      ...
      onClick: b,
      children: !((S = h.notification) != null && S.disabled) && ((V = h.notification) == null ? void 0 : V.showCount) && W.jsx("span", { style: h.notificationBadgeStyle, className: "rcb-badge", children: I })
    }
  ) });
};
var fs = () => {
  var V, P, _, Me, ee;
  const { botOptions: I, setBotOptions: h } = Zt(), [m, b] = (0, import_react.useState)(false), [f, U] = (0, import_react.useState)(false), [F, Y] = (0, import_react.useState)(0);
  (0, import_react.useEffect)(() => {
    var H, x, $;
    ...
    if (re === "ALWAYS")
      if (Pr) {
        let de;
        I.isOpen ? de = (((x = I.chatWindowStyle) == null ? void 0 : x.width) || 375) - ((($ = I.chatButtonStyle) == null ? void 0 : $.width) || 75) : de = 0, Y(de), b(true);
      } else
        I.isOpen ? b(false) : b(true);
    else
      re === "NEVER" ? b(false) : re === "START" ? f ? b(false) : (U(true), b(true)) : re === "CLOSE" && b(!I.isOpen);
  }, [I.isOpen]);
  const j = {
  ...
  return W.jsx(W.Fragment, { children: !((Me = I.theme) != null && Me.embedded) && W.jsxs(
    "div",
    {
      style: j,
      className: `rcb-chat-tooltip ${m ? "rcb-tooltip-show" : "rcb-tooltip-hide"}`,
      onClick: () => h({ ...I, isOpen: true }),
      children: [
        W.jsx("span", { style: { color: "#fff" }, children: (ee = I.tooltip) == null ? void 0 : ee.text }),
        W.jsx("span", { className: "rcb-chat-tooltip-tail", style: S })
      ]
    }
  ) });
};
var ds = ({
  ...
  var j, S, V;
  const { botOptions: m } = Zt(), [b, f] = (0, import_react.useState)(false), U = {
  ...
  return W.jsx("div", { className: "rcb-view-history-container", children: W.jsx(
    "div",
    {
      onMouseEnter: F,
      onMouseLeave: Y,
      ...
      children: W.jsx("p", { children: (V = m.chatHistory) == null ? void 0 : V.viewChatHistoryButtonText })
    }
  ) });
};
var Ms = ({
  ...
  const { botOptions: f } = Zt(), { paths: U } = Na(), [F, Y] = (0, import_react.useState)(/* @__PURE__ */ new Set()), [j, S] = (0, import_react.useState)(false), V = {
  ...
  (0, import_react.useEffect)(() => {
    U.length > 0 && U[U.length - 1] !== m && S(true);
  }, [U]);
  const ee = (Ne) => {
    j || Y((Ze) => {
      const Ce = new Set(Ze);
  ...
  return W.jsxs("div", { className: `rcb-checkbox-container ${(De = f.botBubble) != null && De.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    I.items.map((Ne) => W.jsx(
      "div",
      {
        onMouseDown: (Ze) => {
        ...
        children: W.jsxs("div", { className: "rcb-checkbox-row", children: [
          W.jsx(
            "div",
            {
              style: F.has(Ne) ? Me : _,
          ...
          W.jsx("div", { className: "rcb-checkbox-label", children: Ne })
        ] })
      },
      Ne
    )),
    W.jsx(
      "button",
      {
        ...
        onMouseDown: (Ne) => {
          ...
          S(true), b(m, Ze, (Ce = f.chatInput) == null ? void 0 : Ce.sendCheckboxOutput);
        }
      }
    )
  ] });
...
var ps = ({
  ...
  var Me, ee, re, H, x, $;
  const { botOptions: b } = Zt(), { paths: f } = Na(), [U, F] = (0, import_react.useState)([]), [Y, j] = (0, import_react.useState)(false), S = {
  ...
  (0, import_react.useEffect)(() => {
    f.length > 0 && f[f.length - 1] !== h && j(true);
  }, [f]);
  const P = (de) => {
    F((ye) => {
      const oe = [...ye];
      return oe[de] = true, oe;
    });
  }, _ = (de) => {
    F((ye) => {
      const oe = [...ye];
      return oe[de] = false, oe;
    });
  };
  return W.jsx("div", { className: `rcb-options-container ${($ = b.botBubble) != null && $.showAvatar ? "rcb-options-offset" : ""}`, children: I.map((de, ye) => {
    const oe = U[ye] && !Y;
    return W.jsx(
      "div",
      {
        ...
        onMouseDown: (pe) => {
          var le;
          pe.preventDefault(), !Y && (j(true), m(h, de, (le = b.chatInput) == null ? void 0 : le.sendOptionOutput));
        },
        children: de
      },
      de
...
var vs = (I, h, m, b) => {
  ...
  if (!f)
    return;
  m(W.jsx(ps, { options: f, path: h, handleActionInput: b }));
};
var Ds = async (I, h, m) => {
  const b = I.path;
  if (!b)
...
var Ns = async (I, h, m, b, f) => {
  ...
  if (typeof F == "function" ? (Y = F(m), Y instanceof Promise && (Y = await Y)) : Y = F, !Y || Y instanceof Promise || Y.duration == null || typeof Y.duration != "number")
    return;
  Y.interruptable || (Y.interruptable = false);
  const j = setTimeout(async () => {
    await Fu(I, h, m, b);
  }, Y.duration);
  Y.interruptable && f(j);
};
var js = async (I, h, m, b, f, U, F, Y) => {
  const j = I[h];
  if (!j)
    throw new Error("Block is not valid.");
...
var Fu = async (I, h, m, b) => {
  ...
  return U.includes("path") ? await Ds(f, m, b) : false;
};
var xA = {};
var EA = {};
var bu;
function Ts() {
  return bu || (bu = 1, function() {
    var I = import_react.default, h = "18.2.0", m = I.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    function b(e) {
      {
    ...
    function jt(e) {
      return oe.call(it, e) ? true : oe.call(_e, e) ? false : be.test(e) ? (it[e] = true, true) : (_e[e] = true, f("Invalid attribute name: `%s`", e), false);
    }
    function at(e, r, i, u) {
      if (i !== null && i.type === pe)
        return false;
    ...
    function Rt(e, r) {
      {
        ...
        if (Et.test(r)) {
          ...
          if (u == null)
            return f("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", r), Nt[r] = true, true;
          if (r !== u)
            return f("Invalid ARIA attribute `%s`. Did you mean `%s`?", r, u), Nt[r] = true, true;
        }
        if (It.test(r)) {
          var d = r.toLowerCase(), D = et.hasOwnProperty(d) ? d : null;
          if (D == null)
            return Nt[r] = true, false;
          if (r !== D)
            return f("Unknown ARIA attribute `%s`. Did you mean `%s`?", r, D), Nt[r] = true, true;
        }
      }
      return true;
    }
    ...
    function Lr(e, r) {
      {
        if (e !== "input" && e !== "textarea" && e !== "select")
          return;
        r != null && r.value === null && !Jt && (Jt = true, e === "select" && r.multiple ? f("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.", e) : f("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.", e));
      }
    }
    var Tt = {
      // HTML
    ...
    };
    {
      ...
      yt = function(e, r, i, u) {
        ...
        if (d === "onfocusin" || d === "onfocusout")
          return f("React uses onFocus and onBlur instead of onFocusIn and onFocusOut. All React events are normalized to bubble, so onFocusIn and onFocusOut are not needed/supported by React."), nt[r] = true, true;
        if (u != null) {
          ...
          if (O != null)
            return f("Invalid event handler property `%s`. Did you mean `%s`?", r, O), nt[r] = true, true;
          if (Xt.test(r))
            return f("Unknown event handler property `%s`. It will be ignored.", r), nt[r] = true, true;
        } else if (Xt.test(r))
          return ar.test(r) && f("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", r), nt[r] = true, true;
        if (Yt.test(r) || tt.test(r))
          return true;
        if (d === "innerhtml")
          return f("Directly setting property `innerHTML` is not permitted. For more information, lookup documentation on `dangerouslySetInnerHTML`."), nt[r] = true, true;
        if (d === "aria")
          return f("The `aria` attribute is reserved for future use in React. Pass individual `aria-` attributes instead."), nt[r] = true, true;
        if (d === "is" && i !== null && i !== void 0 && typeof i != "string")
          return f("Received a `%s` for a string attribute `is`. If this is expected, cast the value to a string.", typeof i), nt[r] = true, true;
        if (typeof i == "number" && isNaN(i))
          return f("Received NaN for the `%s` attribute. If this is expected, cast the value to a string.", r), nt[r] = true, true;
        var G = pt(r), ne = G !== null && G.type === pe;
        if (Tt.hasOwnProperty(d)) {
          var ae = Tt[d];
          if (ae !== r)
            return f("Invalid DOM property `%s`. Did you mean `%s`?", r, ae), nt[r] = true, true;
        } else if (!ne && r !== d)
          return f("React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.", r, d), nt[r] = true, true;
        return typeof i == "boolean" && at(r, i, G, false) ? (i ? f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', i, r, r, i, r) : f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', i, r, r, i, r, r, r), nt[r] = true, true) : ne ? true : at(r, i, G, false) ? (nt[r] = true, false) : ((i === "false" || i === "true") && G !== null && G.type === De && (f("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", i, r, i === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', r, i), nt[r] = true), true);
      };
    }
    ...
    {
      var sr = /^(?:webkit|moz|o)[A-Z]/, _t = /^-ms-/, Tr = /-(.)/g, lr = /;\s*$/, Ht = {}, cr = {}, q = false, te = false, ue = function(e) {
        return e.replace(Tr, function(r, i) {
          return i.toUpperCase();
        });
      }, ce = function(e) {
        Ht.hasOwnProperty(e) && Ht[e] || (Ht[e] = true, f(
        ...
        Ht.hasOwnProperty(e) && Ht[e] || (Ht[e] = true, f("Unsupported vendor-prefixed style property %s. Did you mean %s?", e, e.charAt(0).toUpperCase() + e.slice(1)));
      }, je = function(e, r) {
        cr.hasOwnProperty(r) && cr[r] || (cr[r] = true, f(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, e, r.replace(lr, "")));
      }, Ee = function(e, r) {
        q || (q = true, f("`NaN` is an invalid value for the `%s` css style property.", e));
      }, We = function(e, r) {
        te || (te = true, f("`Infinity` is an invalid value for the `%s` css style property.", e));
      };
      qt = function(e, r) {
    ...
    var ut = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i, Rr = false;
    function an(e) {
      !Rr && ut.test(e) && (Rr = true, f("A future version of React will block javascript: URLs as a security precaution. Use event handlers instead if you can. If you need to generate unsafe HTML try using dangerouslySetInnerHTML instead. React was passed %s.", JSON.stringify(e)));
    }
    ...
    var Sr = "<!-- -->";
    function sn(e, r, i, u) {
      return r === "" ? u : (u && e.push(Sr), e.push(Nr(r)), true);
    }
    function ln(e, r, i, u) {
      i && u && e.push(Sr);
    }
      ...
      for (var d in i)
        if (oe.call(i, d)) {
          ...
          if (!(D == null || typeof D == "boolean" || D === "")) {
            ...
            G ? (w = ze(d), de(D, d), O = ze(("" + D).trim())) : (Xe(d, D), w = mr(d), typeof D == "number" ? D !== 0 && !oe.call(Ot, d) ? O = D + "px" : O = "" + D : (de(D, d), O = ze(("" + D).trim()))), u ? (u = false, e.push(cn, w, qr, O)) : e.push(_r, w, qr, O);
          }
        }
      u || e.push(p);
    }
        ...
        if (d !== null) {
          ...
          switch (d.type) {
            case De:
              ...
              return;
            case Ne:
              u === true ? e.push(s, w, z) : u === false || e.push(s, w, g, ze(u), p);
              return;
            case Ze:
    ...
    var ge = false, se = false, Oe = false, Ft = false, xt = false, zt = false, jr = false;
    function er(e, r) {
      {
        var i = e[r];
        if (i != null) {
    ...
    function Er(e) {
      ...
      return I.Children.forEach(e, function(i) {
        i != null && (r += i, !xt && typeof i != "string" && typeof i != "number" && (xt = true, f("Cannot infer the option value of complex children. Pass a `value` prop or use a plain string as children to <option>.")));
      }), r;
    }
    var Yr = ' selected=""';
    function Ir(e, r, i, u) {
        ...
        if (oe.call(r, ne)) {
          ...
          switch (ne) {
            case "children":
              ...
              break;
            case "selected":
              O = ae, jr || (f("Use the `defaultValue` or `value` props on <select> instead of setting `selected` on <option>."), jr = true);
              break;
            case "dangerouslySetInnerHTML":
              G = ae;
              break;
      ...
      if (d != null) {
        var Le;
        if (w !== null ? ($(w, "value"), Le = "" + w) : (G !== null && (zt || (zt = true, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), Le = Er(D)), N(d))
...
` && e.push(dn), d;
    ...
    function Kn(e, r) {
      for (var i = r.bootstrapChunks, u = 0; u < i.length - 1; u++)
        j(e, i[u]);
      return u < i.length ? S(e, i[u]) : true;
    }
    ...
    function nr(e, r, i) {
      j(e, r.startInlineScript), r.sentCompleteSegmentFunction ? j(e, $e) : (r.sentCompleteSegmentFunction = true, j(e, we)), j(e, r.segmentPrefix);
      var u = i.toString(16);
      return j(e, u), j(e, Gt), j(e, r.placeholderPrefix), j(e, u), S(e, rr);
    }
    var Bn = he + ';$RC("', VA = '$RC("', rA = '","', ja = '")<\/script>';
    function Ia(e, r, i, u) {
      if (j(e, r.startInlineScript), r.sentCompleteBoundaryFunction ? j(e, VA) : (r.sentCompleteBoundaryFunction = true, j(e, Bn)), i === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      var d = u.toString(16);
    ...
    function Ea(e, r, i, u, d, D) {
      if (j(e, r.startInlineScript), r.sentClientRenderFunction ? j(e, Ta) : (r.sentClientRenderFunction = true, j(e, wa)), i === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
    ...
    function xi(e, r, i, u) {
      return i.generateStaticMarkup ? (e.push(ze(r)), false) : sn(e, r, i, u);
    }
    function zi(e, r, i, u) {
    ...
    function Ho(e, r) {
      return r.generateStaticMarkup ? true : en(e);
    }
    function hr(e, r, i, u, d) {
      return r.generateStaticMarkup ? true : zn(e, r, i, u, d);
    }
    function za(e, r) {
      return r.generateStaticMarkup ? true : OA(e);
    }
    function ki(e, r) {
      return r.generateStaticMarkup ? true : QA(e);
    }
...
` + O[ne].replace(" at new ", " at ");
        ...
        lA = false, uA.current = D, aA(), Error.prepareStackTrace = d;
      }
    ...
    function ni(e, r, i, u, d) {
      {
        ...
        for (var w in e)
          if (D(e, w)) {
            ...
            O && !(O instanceof Error) && (hn(d), f("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", u || "React class", i, w, typeof O), hn(null)), O instanceof Error && !(O.message in ri) && (ri[O.message] = true, hn(d), f("Failed %s type: %s", i, O.message), hn(null));
          }
      }
    }
    var Ai;
    ...
    function yn(e, r, i, u) {
      {
        if (typeof e.getChildContext != "function") {
          {
            var d = ft(r) || "Unknown";
            Ai[d] || (Ai[d] = true, f("%s.childContextTypes is specified but there is no getChildContext() method on the instance. You can either define getChildContext() on %s or remove childContextTypes from it.", d, d));
          }
          return i;
        }
...
Please check the code for the %s component.`, r, r, u), no[d] = true;
      }
    }
    var Zi = {
      ...
      enqueueReplaceState: function(e, r, i) {
        var u = ro(e);
        u.replace = true, u.queue = [r], i != null && Vn(i, "setState");
      },
    ...
    function Ba(e, r, i) {
      ...
      var O = new e(r, u);
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function" || typeof O.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof O.componentWillMount == "function" && O.componentWillMount.__suppressDeprecationWarning !== true ? ne = "componentWillMount" : typeof O.UNSAFE_componentWillMount == "function" && (ne = "UNSAFE_componentWillMount"), typeof O.componentWillReceiveProps == "function" && O.componentWillReceiveProps.__suppressDeprecationWarning !== true ? ae = "componentWillReceiveProps" : typeof O.UNSAFE_componentWillReceiveProps == "function" && (ae = "UNSAFE_componentWillReceiveProps"), typeof O.componentWillUpdate == "function" && O.componentWillUpdate.__suppressDeprecationWarning !== true ? Le = "componentWillUpdate" : typeof O.UNSAFE_componentWillUpdate == "function" && (Le = "UNSAFE_componentWillUpdate"), ne !== null || ae !== null || Le !== null) {
  ...
  ` + Le : ""));
    ...
    function Ua(e, r) {
      ...
      if (typeof r.componentWillMount == "function") {
        if (r.componentWillMount.__suppressDeprecationWarning !== true) {
          var u = ft(e) || "Unknown";
          Ao[u] || (b(
...
Please update the following components: %s`,
    ...
    function Ra(e, r, i, u) {
      if (e.queue !== null && e.queue.length > 0) {
        ...
        if (e.queue = null, e.replace = false, D && d.length === 1)
          r.state = d[0];
        else {
          for (var w = D ? d[0] : r.state, O = true, G = D ? 1 : 0; G < d.length; G++) {
            var ne = d[G], ae = typeof ne == "function" ? ne.call(r, w, i, u) : ne;
            ae != null && (O ? (O = false, w = Ar({}, w, ae)) : Ar(w, ae));
          }
          r.state = w;
        }
      } else
    ...
    var Mo = typeof Object.is == "function" ? Object.is : li, Qe = null, vn = null, Dn = null, Je = null, yr = false, Ln = false, go = 0, kt = null, Wr = 0, Nn = 25, br = false, jn;
    function Vr() {
      if (Qe === null)
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
    ...
    function Ga(e, r) {
      if (r === null)
        return f("%s received a final argument during this render, but not during the previous render. Even though the final argument is optional, its type cannot change between renders.", jn), false;
...
Incoming: %s`, jn, "[" + e.join(", ") + "]", "[" + r.join(", ") + "]");
    ...
    function ho() {
      return Je === null ? Dn === null ? (yr = false, Dn = Je = Ji()) : (yr = true, Je = Dn) : Je.next === null ? (yr = false, Je = Je.next = Ji()) : (yr = true, Je = Je.next), Je;
    }
    function ci(e, r) {
      Qe = r, vn = e, br = false, go = 0;
    }
    function Za(e, r, i, u) {
      for (; Ln; )
        Ln = false, go = 0, Wr += 1, Je = null, i = e(r, u);
      return hA(), i;
    }
    function Ki() {
      var e = go !== 0;
    ...
    function hA() {
      br = false, Qe = null, vn = null, Ln = false, Dn = null, Wr = 0, kt = null, Je = null;
    }
    function Xa(e) {
      ...
      if (e !== yo && (jn = "useReducer"), Qe = Vr(), Je = ho(), yr) {
        ...
        if (kt !== null) {
          ...
          if (D !== void 0) {
            ...
            do {
              var G = O.action;
              br = true, w = e(w, G), br = false, O = O.next;
            } while (O !== null);
        ...
        br = true;
        var ne;
        e === yo ? ne = typeof r == "function" ? r() : r : ne = i !== void 0 ? i(r) : r, br = false, Je.memoizedState = ne;
        var ae = Je.queue = {
          last: null,
          dispatch: null
    ...
    function $i(e, r) {
      ...
      br = true;
      var D = e();
      return br = false, Je.memoizedState = [D, i], D;
    }
    function Ka(e) {
      Qe = Vr(), Je = ho();
...
` + u.stack;
    ...
    function Aa(e, r, i) {
      ...
      d.children.push(ae), d.lastPushedText = false;
      var Le = An(
        e,
        0,
        null,
      ...
      Le.parentFlushed = true, r.blockedBoundary = G, r.blockedSegment = Le;
      try {
        ...
        Le.status = wn, G.forceClientRender = true, G.errorDigest = LA(e, bt), pi(G, bt);
      } finally {
    ...
    function oa(e, r, i, u) {
      ...
      d.formatContext = Jr(w, i, u), Io(e, r, D), d.formatContext = w, tr(d.chunks, i), d.lastPushedText = false, vr(r);
    }
    function iu(e) {
    ...
    function NA(e, r, i, u, d) {
      var D = i.render();
      i.props !== d && (ji || f("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", ft(u) || "a component"), ji = true);
      {
    ...
    var Di = {}, jA = {}, Li = {}, Ni = {}, ji = false, aa = false, ua = false, Ii = false;
    function au(e, r, i, u) {
      var d;
      if (d = Hi(i, r.legacyContext), Gn(r, i), i.prototype && typeof i.prototype.render == "function") {
        var D = ft(i) || "Unknown";
        Di[D] || (f("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", D, D), Di[D] = true);
      }
      var w = vi(e, r, i, u, d), O = Ki();
      if (typeof w == "object" && w !== null && typeof w.render == "function" && w.$$typeof === void 0) {
        var G = ft(i) || "Unknown";
        jA[G] || (f("The <%s /> component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype = React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.", G, G, G), jA[G] = true);
      }
      if (
    ...
    function uu(e) {
      {
        if (e && e.childContextTypes && f("%s(...): childContextTypes cannot be defined on a function component.", e.displayName || e.name || "Component"), typeof e.getDerivedStateFromProps == "function") {
          var r = ft(e) || "Unknown";
          Ni[r] || (f("%s: Function components do not support getDerivedStateFromProps.", r), Ni[r] = true);
        }
        if (typeof e.contextType == "object" && e.contextType !== null) {
          var i = ft(e) || "Unknown";
          Li[i] || (f("%s: Function components do not support contextType.", i), Li[i] = true);
        }
      }
    }
    function sa(e, r) {
    ...
    function wi(e, r, i, u) {
      i._context === void 0 ? i !== i.Consumer && (Ii || (Ii = true, f("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : i = i._context;
      var d = u.children;
    ...
    function la(e, r) {
      ...
      e[Symbol.toStringTag] === "Generator" && (aa || f("Using Generators as children is unsupported and will likely yield unexpected results because enumerating a generator mutates it. You may convert it to an array with `Array.from()` or the `[...spread]` operator before rendering. Keep in mind you might need to polyfill these features for older browsers."), aa = true), e.entries === r && (ua || f("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), ua = true);
    }
    function ir(e, r, i) {
      try {
        return Si(e, r, i);
    ...
    function fu(e, r, i) {
      ...
      u.children.push(D), u.lastPushedText = false;
    ...
    function wo(e, r, i, u) {
      var d = LA(e, u);
      if (r === null ? jo(e, u) : (r.pendingTasks--, r.forceClientRender || (r.forceClientRender = true, r.errorDigest = d, pi(r, u), r.parentFlushed && e.clientRenderedBoundaries.push(r))), e.allPendingTasks--, e.allPendingTasks === 0) {
        var D = e.onAllReady;
        D();
      }
    }
    ...
    function IA(e, r) {
      if (r.chunks.length === 0 && r.children.length === 1 && r.children[0].boundary === null) {
        var i = r.children[0];
        i.id = r.id, i.parentFlushed = true, i.status === In && IA(e, i);
      } else {
    ...
    function TA(e, r, i) {
      switch (i.parentFlushed = true, i.status) {
        case Lo: {
          var u = i.id = e.nextSegmentId++;
          return i.lastPushedText = false, i.textEmbedded = false, kA(r, e.responseState, u);
        }
        case In: {
          i.status = ra;
          for (var d = true, D = i.chunks, w = 0, O = i.children, G = 0; G < O.length; G++) {
    ...
    function SA(e, r, i) {
      ...
      if (u === null)
        return TA(e, r, i);
      if (u.parentFlushed = true, u.forceClientRender)
    ...
    function Mu(e, r, i) {
      for (var u = i.completedSegments, d = 0; d < u.length; d++) {
        var D = u[d];
        if (!ga(e, r, i, D))
          return d++, u.splice(0, d), false;
      }
      return u.splice(0, d), true;
    }
    function ga(e, r, i, u) {
      if (u.status === ra)
        return true;
    ...
    function c(e, r, i, u) {
      var d = false, D = null, w = "", O = {
        push: function(Le) {
          return Le !== null && (w += Le), true;
        },
        destroy: function(Le) {
          d = true, D = Le;
        }
    ...
    function y(e, r) {
      return c(e, r, false, 'The server used "renderToString" which does not support Suspense. If you intended for this Suspense boundary to render the fallback content on the server consider throwing an Error somewhere within the Suspense boundary. If you intended to have the server wait for the suspended component please switch to "renderToReadableStream" which supports Suspense on the server');
    }
    function L(e, r) {
      return c(e, r, true, 'The server used "renderToStaticMarkup" which does not support Suspense. If you intended to have the server wait for the suspended component please switch to "renderToReadableStream" which supports Suspense on the server');
    }
    function T() {
...
function Ss() {
  return Ou || (Ou = 1, function() {
    ...
    function Ue(t) {
      return De.call(Be, t) ? true : De.call(pt, t) ? false : at.test(t) ? (Be[t] = true, true) : (pt[t] = true, f("Invalid attribute name: `%s`", t), false);
    }
    function He(t, n, a, c) {
      if (a !== null && a.type === Ne)
        return false;
    ...
    function Lr(t, n) {
      {
        ...
        if (Jt.test(n)) {
          ...
          if (c == null)
            return f("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", n), wt[n] = true, true;
          if (n !== c)
            return f("Invalid ARIA attribute `%s`. Did you mean `%s`?", n, c), wt[n] = true, true;
        }
        if (Ct.test(n)) {
          var y = n.toLowerCase(), L = Rt.hasOwnProperty(y) ? y : null;
          if (L == null)
            return wt[n] = true, false;
          if (n !== L)
            return f("Unknown ARIA attribute `%s`. Did you mean `%s`?", n, L), wt[n] = true, true;
        }
      }
      return true;
    }
    ...
    };
    {
      ...
      Yt = function(t, n, a, c) {
        ...
        if (y === "onfocusin" || y === "onfocusout")
          return f("React uses onFocus and onBlur instead of onFocusIn and onFocusOut. All React events are normalized to bubble, so onFocusIn and onFocusOut are not needed/supported by React."), tt[n] = true, true;
        if (c != null) {
          ...
          if (Q != null)
            return f("Invalid event handler property `%s`. Did you mean `%s`?", n, Q), tt[n] = true, true;
          if (Kt.test(n))
            return f("Unknown event handler property `%s`. It will be ignored.", n), tt[n] = true, true;
        } else if (Kt.test(n))
          return ur.test(n) && f("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", n), tt[n] = true, true;
        if (qt.test(n) || sr.test(n))
          return true;
        if (y === "innerhtml")
          return f("Directly setting property `innerHTML` is not permitted. For more information, lookup documentation on `dangerouslySetInnerHTML`."), tt[n] = true, true;
        if (y === "aria")
          return f("The `aria` attribute is reserved for future use in React. Pass individual `aria-` attributes instead."), tt[n] = true, true;
        if (y === "is" && a !== null && a !== void 0 && typeof a != "string")
          return f("Received a `%s` for a string attribute `is`. If this is expected, cast the value to a string.", typeof a), tt[n] = true, true;
        if (typeof a == "number" && isNaN(a))
          return f("Received NaN for the `%s` attribute. If this is expected, cast the value to a string.", n), tt[n] = true, true;
        var e = Fe(n), r = e !== null && e.type === Ne;
        if (ar.hasOwnProperty(y)) {
          var i = ar[y];
          if (i !== n)
            return f("Invalid DOM property `%s`. Did you mean `%s`?", n, i), tt[n] = true, true;
        } else if (!r && n !== y)
          return f("React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.", n, y), tt[n] = true, true;
        return typeof a == "boolean" && He(n, a, e, false) ? (a ? f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', a, n, n, a, n) : f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', a, n, n, a, n, n, n), tt[n] = true, true) : r ? true : He(n, a, e, false) ? (tt[n] = true, false) : ((a === "false" || a === "true") && e !== null && e.type === Ke && (f("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", a, n, a === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', n, a), tt[n] = true), true);
      };
    }
    ...
    {
      var Ht = /^(?:webkit|moz|o)[A-Z]/, cr = /^-ms-/, q = /-(.)/g, te = /;\s*$/, ue = {}, ce = {}, Ae = false, je = false, Ee = function(t) {
        return t.replace(q, function(n, a) {
          return a.toUpperCase();
        });
      }, We = function(t) {
        ue.hasOwnProperty(t) && ue[t] || (ue[t] = true, f(
          "Unsupported style property %s. Did you mean %s?",
          t,
          // As Andi Smith suggests
          // (http://www.andismith.com/blog/2012/02/modernizr-prefixed/), an `-ms` prefix
        ...
        ue.hasOwnProperty(t) && ue[t] || (ue[t] = true, f("Unsupported vendor-prefixed style property %s. Did you mean %s?", t, t.charAt(0).toUpperCase() + t.slice(1)));
      }, dt = function(t, n) {
        ce.hasOwnProperty(n) && ce[n] || (ce[n] = true, f(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, t, n.replace(te, "")));
      }, Mt = function(t, n) {
        Ae || (Ae = true, f("`NaN` is an invalid value for the `%s` css style property.", t));
      }, ze = function(t, n) {
        je || (je = true, f("`Infinity` is an invalid value for the `%s` css style property.", t));
      };
      lr = function(t, n) {
    ...
    var N = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i, Z = false;
    function K(t) {
      !Z && N.test(t) && (Z = true, f("A future version of React will block javascript: URLs as a security precaution. Use event handlers instead if you can. If you need to generate unsafe HTML try using dangerouslySetInnerHTML instead. React was passed %s.", JSON.stringify(t)));
    }
    ...
    var cn = x("<!-- -->");
    function qr(t, n, a, c) {
      return n === "" ? c : (c && t.push(cn), t.push(H(mr(n))), true);
    }
    function _r(t, n, a, c) {
      a && c && t.push(cn);
    }
      ...
      for (var y in a)
        if (De.call(a, y)) {
          ...
          if (!(L == null || typeof L == "boolean" || L === "")) {
            ...
            e ? (T = H(ut(y)), le(L, y), Q = H(ut(("" + L).trim()))) : (Qt(y, L), T = s(y), typeof L == "number" ? L !== 0 && !De.call(Dt, y) ? Q = H(L + "px") : Q = H("" + L) : (le(L, y), Q = H(ut(("" + L).trim())))), c ? (c = false, t.push(g, T, p, Q)) : t.push(z, T, p, Q);
          }
        }
      c || t.push(ie);
    }
        ...
        if (y !== null) {
          ...
          switch (y.type) {
            case Ke:
              ...
              return;
            case ve:
              c === true ? t.push(B, T, ge) : c === false || t.push(B, T, X, H(ut(c)), ie);
              return;
            case be:
    ...
    var zt = false, jr = false, er = false, $r = false, Er = false, Yr = false, Ir = false;
    function fn(t, n) {
      {
        var a = t[n];
        if (a != null) {
    ...
    function ko(t) {
      ...
      return I.Children.forEach(t, function(a) {
        a != null && (n += a, !Er && typeof a != "string" && typeof a != "number" && (Er = true, f("Cannot infer the option value of complex children. Pass a `value` prop or use a plain string as children to <option>.")));
      }), n;
    }
    var Xn = x(' selected=""');
    function bo(t, n, a, c) {
        ...
        if (De.call(n, r)) {
          ...
          switch (r) {
            case "children":
              ...
              break;
            case "selected":
              Q = i, Ir || (f("Use the `defaultValue` or `value` props on <select> instead of setting `selected` on <option>."), Ir = true);
              break;
            case "dangerouslySetInnerHTML":
              e = i;
              break;
      ...
      if (y != null) {
        var u;
        if (T !== null ? (pe(T, "value"), u = "" + T) : (e !== null && (Yr || (Yr = true, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), u = ko(L)), Te(y))
    ...
    function Jn(t, n, a) {
      It("input", n), n.checked !== void 0 && n.defaultChecked !== void 0 && !jr && (f("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", n.type), jr = true), n.value !== void 0 && n.defaultValue !== void 0 && !zt && (f("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", n.type), zt = true), t.push(tr("input"));
...
` && t.push(Hr), y;
    ...
    function Oo(t, n) {
      for (var a = n.bootstrapChunks, c = 0; c < a.length - 1; c++)
        P(t, a[c]);
      return c < a.length ? _(t, a[c]) : true;
    }
    ...
    function Ia(t, n, a) {
      P(t, n.startInlineScript), n.sentCompleteSegmentFunction ? P(t, VA) : (n.sentCompleteSegmentFunction = true, P(t, Bn)), P(t, n.segmentPrefix);
      var c = H(a.toString(16));
      return P(t, c), P(t, rA), P(t, n.placeholderPrefix), P(t, c), _(t, ja);
    }
    var wa = x(rr + ';$RC("'), Ta = x('$RC("'), Sa = x('","'), ma = x('")<\/script>');
    function Uo(t, n, a, c) {
      if (P(t, n.startInlineScript), n.sentCompleteBoundaryFunction ? P(t, Ta) : (n.sentCompleteBoundaryFunction = true, P(t, wa)), a === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
    ...
    function xi(t, n, a, c, y, L) {
      if (P(t, n.startInlineScript), n.sentClientRenderFunction ? P(t, Ca) : (n.sentClientRenderFunction = true, P(t, Ea)), a === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
...
` + Q[r].replace(" at new ", " at ");
        ...
        uA = false, KA.current = L, Ui(), Error.prepareStackTrace = y;
      }
    ...
    function ri(t, n, a, c, y) {
      {
        ...
        for (var T in t)
          if (L(t, T)) {
            ...
            Q && !(Q instanceof Error) && (Hn(y), f("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", c || "React class", a, T, typeof Q), Hn(null)), Q instanceof Error && !(Q.message in ti) && (ti[Q.message] = true, Hn(y), f("Failed %s type: %s", a, Q.message), Hn(null));
          }
      }
    }
    var _A;
    ...
    function Ai(t, n, a, c) {
      {
        if (typeof t.getChildContext != "function") {
          {
            var y = gt(n) || "Unknown";
            _A[y] || (_A[y] = true, f("%s.childContextTypes is specified but there is no getChildContext() method on the instance. You can either define getChildContext() on %s or remove childContextTypes from it.", y, y));
          }
          return a;
        }
...
Please check the code for the %s component.`, n, n, c), Fn[y] = true;
      }
    }
    var so = {
      ...
      enqueueReplaceState: function(t, n, a) {
        var c = ai(t);
        c.replace = true, c.queue = [n], a != null && Wn(a, "setState");
      },
    ...
    function Gi(t, n, a) {
      ...
      var Q = new t(n, c);
      {
        ...
        if (typeof t.getDerivedStateFromProps == "function" || typeof Q.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof Q.componentWillMount == "function" && Q.componentWillMount.__suppressDeprecationWarning !== true ? r = "componentWillMount" : typeof Q.UNSAFE_componentWillMount == "function" && (r = "UNSAFE_componentWillMount"), typeof Q.componentWillReceiveProps == "function" && Q.componentWillReceiveProps.__suppressDeprecationWarning !== true ? i = "componentWillReceiveProps" : typeof Q.UNSAFE_componentWillReceiveProps == "function" && (i = "UNSAFE_componentWillReceiveProps"), typeof Q.componentWillUpdate == "function" && Q.componentWillUpdate.__suppressDeprecationWarning !== true ? u = "componentWillUpdate" : typeof Q.UNSAFE_componentWillUpdate == "function" && (u = "UNSAFE_componentWillUpdate"), r !== null || i !== null || u !== null) {
  ...
  ` + u : ""));
    ...
    function Pa(t, n) {
      ...
      if (typeof n.componentWillMount == "function") {
        if (n.componentWillMount.__suppressDeprecationWarning !== true) {
          var c = gt(t) || "Unknown";
          ro[c] || (b(
            // keep this warning in sync with ReactStrictModeWarning.js
            `componentWillMount has been renamed, and is not recommended for use. See https://reactjs.org/link/unsafe-component-lifecycles for details.
...
Please update the following components: %s`,
    ...
    function Ba(t, n, a, c) {
      if (t.queue !== null && t.queue.length > 0) {
        ...
        if (t.queue = null, t.replace = false, L && y.length === 1)
          n.state = y[0];
        else {
          for (var T = L ? y[0] : n.state, Q = true, e = L ? 1 : 0; e < y.length; e++) {
            var r = y[e], i = typeof r == "function" ? r.call(n, T, a, c) : r;
            i != null && (Q ? (Q = false, T = hr({}, T, i)) : hr(T, i));
          }
          n.state = T;
        }
      } else
    ...
    var Va = typeof Object.is == "function" ? Object.is : Wa, Fr = null, li = null, Mo = null, Qe = null, vn = false, Dn = false, Je = 0, yr = null, Ln = 0, go = 25, kt = false, Wr;
    function Nn() {
      if (Fr === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
    ...
    function br(t, n) {
      if (n === null)
        return f("%s received a final argument during this render, but not during the previous render. Even though the final argument is optional, its type cannot change between renders.", Wr), false;
...
Incoming: %s`, Wr, "[" + t.join(", ") + "]", "[" + n.join(", ") + "]");
    ...
    function Vr() {
      return Qe === null ? Mo === null ? (vn = false, Mo = Qe = jn()) : (vn = true, Qe = Mo) : Qe.next === null ? (vn = false, Qe = Qe.next = jn()) : (vn = true, Qe = Qe.next), Qe;
    }
    function Ga(t, n) {
      Fr = n, li = t, kt = false, Je = 0;
    }
    function Ji(t, n, a, c) {
      for (; Dn; )
        Dn = false, Je = 0, Ln += 1, Qe = null, a = t(n, c);
      return ci(), a;
    }
    function ho() {
      var t = Je !== 0;
    ...
    function ci() {
      kt = false, Fr = null, li = null, Dn = false, Mo = null, Ln = 0, yr = null, Qe = null;
    }
    function Za(t) {
      ...
      if (t !== hA && (Wr = "useReducer"), Fr = Nn(), Qe = Vr(), vn) {
        ...
        if (yr !== null) {
          ...
          if (L !== void 0) {
            ...
            do {
              var e = Q.action;
              kt = true, T = t(T, e), kt = false, Q = Q.next;
            } while (Q !== null);
        ...
        kt = true;
        var r;
        t === hA ? r = typeof n == "function" ? n() : n : r = a !== void 0 ? a(n) : n, kt = false, Qe.memoizedState = r;
        var i = Qe.queue = {
          last: null,
          dispatch: null
    ...
    function yo(t, n) {
      ...
      kt = true;
      var L = t();
      return kt = false, Qe.memoizedState = [L, a], L;
    }
    function Ja(t) {
      Fr = Nn(), Qe = Vr();
...
` + c.stack;
    ...
    function pi(t, n, a) {
      ...
      y.children.push(i), y.lastPushedText = false;
      var u = No(
        t,
        0,
        null,
      ...
      u.parentFlushed = true, n.blockedBoundary = e, n.blockedSegment = u;
      try {
        ...
        u.status = In, e.forceClientRender = true, e.errorDigest = vr(t, D), yi(e, D);
      } finally {
    ...
    function LA(t, n, a, c) {
      ...
      y.lastPushedText = false;
      var T = y.formatContext;
      y.formatContext = Sr(T, a, c), Si(t, n, L), y.formatContext = T, bA(y.chunks, a), y.lastPushedText = false, pr(n);
    }
    function jo(t) {
    ...
    function oa(t, n, a, c, y) {
      var L = a.render();
      a.props !== y && (jA || f("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", gt(c) || "a component"), jA = true);
      {
    ...
    var vi = {}, NA = {}, ia = {}, Di = {}, jA = false, Li = false, Ni = false, ji = false;
    function aa(t, n, a, c) {
      var y;
      if (y = ni(a, n.legacyContext), Qr(n, a), a.prototype && typeof a.prototype.render == "function") {
        var L = gt(a) || "Unknown";
        vi[L] || (f("The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.", L, L), vi[L] = true);
      }
      var T = Aa(t, n, a, c, y), Q = ho();
      if (typeof T == "object" && T !== null && typeof T.render == "function" && T.$$typeof === void 0) {
        var e = gt(a) || "Unknown";
        NA[e] || (f("The <%s /> component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype = React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.", e, e, e), NA[e] = true);
      }
      if (
        // Run these checks in production only if the flag is off.
        // Eventually we'll delete this branch altogether.
        ...
        {
          var r = gt(a) || "Unknown";
          NA[r] || (f("The <%s /> component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype = React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.", r, r, r), NA[r] = true);
        }
    ...
    function ua(t) {
      {
        if (t && t.childContextTypes && f("%s(...): childContextTypes cannot be defined on a function component.", t.displayName || t.name || "Component"), typeof t.getDerivedStateFromProps == "function") {
          var n = gt(t) || "Unknown";
          Di[n] || (f("%s: Function components do not support getDerivedStateFromProps.", n), Di[n] = true);
        }
        if (typeof t.contextType == "object" && t.contextType !== null) {
          var a = gt(t) || "Unknown";
          ia[a] || (f("%s: Function components do not support contextType.", a), ia[a] = true);
        }
      }
    }
    function Ii(t, n) {
    ...
    function sa(t, n, a, c) {
      a._context === void 0 ? a !== a.Consumer && (ji || (ji = true, f("Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?"))) : a = a._context;
      var y = c.children;
    ...
    function ir(t, n, a) {
      ...
      c.children.push(L), c.lastPushedText = false;
    ...
    function ca(t, n, a, c) {
      var y = vr(t, c);
      if (n === null ? on(t, c) : (n.pendingTasks--, n.forceClientRender || (n.forceClientRender = true, n.errorDigest = y, yi(n, c), n.parentFlushed && t.clientRenderedBoundaries.push(n))), t.allPendingTasks--, t.allPendingTasks === 0) {
        var L = t.onAllReady;
        L();
      }
    }
    ...
    function wo(t, n) {
      if (n.chunks.length === 0 && n.children.length === 1 && n.children[0].boundary === null) {
        var a = n.children[0];
        a.id = n.id, a.parentFlushed = true, a.status === nn && wo(t, a);
      } else {
    ...
    function wA(t, n, a) {
      switch (a.parentFlushed = true, a.status) {
        case di: {
          ...
          return a.lastPushedText = false, a.textEmbedded = false, Cn(n, t.responseState, c);
        }
        case nn: {
          a.status = Do;
          for (var y = true, L = a.chunks, T = 0, Q = a.children, e = 0; e < Q.length; e++) {
    ...
    function To(t, n, a) {
      ...
      if (c === null)
        return wA(t, n, a);
      if (c.parentFlushed = true, c.forceClientRender)
    ...
    function du(t, n, a) {
      for (var c = a.completedSegments, y = 0; y < c.length; y++) {
        var L = c[y];
        if (!mi(t, n, a, L))
          return y++, c.splice(0, y), false;
      }
      return c.splice(0, y), true;
    }
    function mi(t, n, a, c) {
      if (c.status === Do)
        return true;
...
var ms = () => {
  ...
  return W.jsx("div", { className: "rcb-line-break-container", children: W.jsx("div", { style: I.chatHistoryLineBreakStyle, className: "rcb-line-break-text", children: (h = I.chatHistory) == null ? void 0 : h.chatHistoryLineBreakText }) });
};
var Es = () => {
  var m;
  ...
  return W.jsx("div", { className: "rcb-spinner-container", children: W.jsx("div", { style: h, className: "rcb-spinner" }) });
};
var Wu = false;
var Nu = "rcb-history";
var La = 30;
...
var zs = (I) => (0, import_react.isValidElement)(I.content) ? structuredClone({
      ...
      setTimeout(() => {
        ...
        m((Y) => {
          ...
          return (S = I.chatHistory) != null && S.autoLoad ? j = {
            content: W.jsx(W.Fragment, {}),
            sender: "system"
          } : j = {
            content: W.jsx(ms, {}),
            sender: "system"
          }, [...U, j, ...Y];
        }), b(((F = I.chatInput) == null ? void 0 : F.disabled) || false);
      }, 500);
    } catch {
...
var Gu = (I, h) => {
  ...
  return Array.from(b.body.childNodes).map((F, Y) => {
      ...
      return F.textContent;
    {
      ...
      return (0, import_react.createElement)(S, { key: Y, ...V }, _);
    }
  });
};
var ks = (I, h) => ((I.contains("rcb-options-container") || I.contains("rcb-checkbox-container")) && (Object.prototype.hasOwnProperty.call(h, "class") ? h.class = `${I.toString()} rcb-options-offset` : h.class = "rcb-options-offset"), h);
var bs = (I, h, m) => {
  var b, f, U, F, Y;
...
var Ps = (I, h, m, b, f) => {
  ...
  for (const Y in m)
    if (window.speechSynthesis.getVoices().find((j) => {
      if (j.name === Y) {
        U.voice = j, window.speechSynthesis.speak(U), F = true;
        return;
      }
    }), F)
      break;
...
var Us = ({ flow: I }) => {
  ...
  const { botOptions: h, setBotOptions: m } = Zt(), { messages: b, setMessages: f } = Yu(), { paths: U, setPaths: F } = Na(), Y = (0, import_react.useRef)(null), j = (0, import_react.useRef)(null), S = (0, import_react.useRef)(""), V = (0, import_react.useRef)(false), P = (0, import_react.useRef)(false), _ = (0, import_react.useRef)(null), Me = (0, import_react.useRef)(), ee = (0, import_react.useRef)(null), [re, H] = (0, import_react.useState)(false), [x, $] = (0, import_react.useState)(false), [de, ye] = (0, import_react.useState)(true), [oe, pe] = (0, import_react.useState)(false), [le, Ge] = (0, import_react.useState)(false), [De, Ne] = (0, import_react.useState)(false), [Ze, Ce] = (0, import_react.useState)(false), [Ke, ve] = (0, import_react.useState)(false), [be, _e] = (0, import_react.useState)(false), [it, jt] = (0, import_react.useState)(0), [at, pt] = (0, import_react.useState)(false), [Be, Ue] = (0, import_react.useState)(), [He, Fe] = (0, import_react.useState)(0), [Pe, xe] = (0, import_react.useState)(((Kt = window.visualViewport) == null ? void 0 : Kt.height) || window.innerHeight), [Ot, vt] = (0, import_react.useState)(((ur = window.visualViewport) == null ? void 0 : ur.width) || window.innerWidth), ht = (0, import_react.useRef)(0);
  (0, import_react.useEffect)(() => {
    ...
    if (window.addEventListener("click", Lt), window.addEventListener("keydown", Lt), window.addEventListener("touchstart", Lt), Dt(), Ne((q = h.chatInput) == null ? void 0 : q.disabled), pe((te = h.audio) == null ? void 0 : te.defaultToggledOn), Ge((ue = h.voice) == null ? void 0 : ue.defaultToggledOn), (ce = h.chatHistory) != null && ce.disabled)
      ...
      We != null && (f([{
        content: W.jsx(ds, { chatHistory: We, showChatHistory: Jt }),
        sender: "system"
    ...
    xs(h);
  }, [(qt = h.chatHistory) == null ? void 0 : qt.storageKey, (sr = h.chatHistory) == null ? void 0 : sr.maxEntries, (_t = h.chatHistory) == null ? void 0 : _t.disabled]), (0, import_react.useEffect)(() => {
    var q;
    Pr || (q = h.theme) != null && q.embedded || navigator.virtualKeyboard && (navigator.virtualKeyboard.overlaysContent = true, navigator.virtualKeyboard.addEventListener("geometrychange", (te) => {
      if (!te.target)
        return;
    ...
    Qu(b), Nt();
  }, [b.length]), (0, import_react.useEffect)(() => {
    V.current || Qu(b);
  }, [V.current]), (0, import_react.useEffect)(() => {
    var Ae, je, Ee, We;
  ...
  }, [h.isOpen]), (0, import_react.useEffect)(() => {
    const q = It();
    if (!q)
      return;
    const te = I[q];
  ...
  const mt = async (q, te, ue) => {
    q === "start" && Ne(true), await js(
      ...
      Ue,
      Xt
    ), pt(false), Lr(), yu(P.current && !te.chatDisabled, h), V.current = false;
  }, Dt = async () => {
    var ce, Ae, je;
    ...
    var te;
    H(true), !x && ((te = h.theme) == null ? void 0 : te.flowStartTrigger) === "ON_PAGE_INTERACT" && $(true);
    ...
    pt(false), f((We) => [...We, q]), V.current = true;
    let ce = q.content;
    ue && (ce = is(ce));
    let Ae = 0;
    const je = ce.length;
    ...
    const ue = { content: q, sender: te };
    if (!V.current) {
      pt(false), f((ce) => [...ce, ue]), V.current = true;
      return;
    }
    f((ce) => {
      const Ae = [...ce];
    ...
    }, 100), te.isSensitive ? Ce(te.isSensitive) : Ce(false);
  }, Tt = () => {
    ye((q) => !q);
  }, yt = () => {
    pe((q) => !q);
    ...
    De || Ge((q) => !q);
  }, Xt = async (q, te, ue = true) => {
    var ce, Ae;
    clearTimeout(Be), te = te.trim(), S.current = te, te !== "" && (ue && await ar(te), Y.current && (Y.current.scrollTop = Y.current.scrollHeight), j.current && (j.current.value = ""), (ce = h.chatInput) != null && ce.blockSpam && Ne(true), P.current = le, yu(false, h), setTimeout(() => {
      pt(true);
    }, 400), setTimeout(async () => {
      const je = { prevPath: Et(), userInput: te, injectMessage: Rt, streamMessage: Ct, openChat: et };
      await Fu(I, q, je, F) || (Lr(), yu(P.current, h), pt(false));
  ...
  return W.jsxs(
    "div",
    {
      onMouseDown: (q) => {
        var te, ue;
        !x && ((te = h.theme) == null ? void 0 : te.flowStartTrigger) === "ON_CHATBOT_INTERACT" && $(true), Pr ? (ue = j.current) == null || ue.blur() : q == null || q.preventDefault();
      },
      className: Yt(),
      children: [
        W.jsx(fs, {}),
        W.jsx(cs, { unreadCount: He }),
        h.isOpen && !Pr && !((Tr = h.theme) != null && Tr.embedded) && W.jsxs(W.Fragment, { children: [
        ...
        W.jsxs(
          "div",
          {
            ...
            children: [
              ((lr = h.theme) == null ? void 0 : lr.showHeader) && W.jsx(
                $u,
                {
              ...
              ((Ht = h.theme) == null ? void 0 : Ht.showInputRow) && W.jsx(
                as,
                {
              ...
              ((cr = h.theme) == null ? void 0 : cr.showFooter) && W.jsx(
                ls,
                {
                  inputRef: j,
                  flow: I,
...
var Su = {
  ...
  header: {
    title: W.jsx("h3", { style: { cursor: "pointer", margin: 0 }, onClick: () => window.open("https://github.com/tjtanjin/"), children: "Tan Jin" }),
    showAvatar: true,
    avatar: Bu,
    closeChatIcon: qs
  },
  ...
  footer: {
    text: W.jsxs(
      "div",
      {
        ...
        children: [
          W.jsx("span", { children: "Powered By " }),
          W.jsxs("span", { style: { fontWeight: "bold" }, children: [
            W.jsx("img", { style: { width: 10, height: 10 }, src: Rs }),
            W.jsx("span", { children: " React ChatBotify" })
          ] })
        ]
      }
    )
...
var fl = ({
  ...
  var ee;
  const [m, b] = (0, import_react.useState)(al(h)), [f, U] = (0, import_react.useState)([]), [F, Y] = (0, import_react.useState)([]), j = I ?? os, S = (re) => W.jsx(Uu.Provider, { value: { botOptions: m, setBotOptions: b }, children: re }), V = (re) => W.jsx(Hu.Provider, { value: { paths: F, setPaths: Y }, children: re }), P = (re) => W.jsx(Ru.Provider, { value: { messages: f, setMessages: U }, children: re }), _ = () => {
    var H, x, $;
    let re = W.jsx(Us, { flow: j });
  ...
  return W.jsx(W.Fragment, { children: Me() && W.jsx("div", { style: { fontFamily: (ee = m.theme) == null ? void 0 : ee.fontFamily }, children: _() }) });
};
export {
...
react-chatbotify/dist/index.js:
  (**
   * @license React
